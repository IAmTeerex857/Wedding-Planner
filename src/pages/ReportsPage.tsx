...
import { Download, FileText, Printer } from '../components/Icon'
...
const csvReports = [
  ...
  { name: 'Ceremony requirements', file: 'ceremony-requirements', table: 'traditional_requirements', columns: 'category,item_name,required_quantity,unit,responsible_party,estimated_minor,actual_minor,currency,due_date,status,approval_status' },
