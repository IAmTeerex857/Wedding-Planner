...
const definitions: Record<string, Definition> = {
  ...
  Vendors: { eyebrow: 'Supplier directory', description: 'Compare suppliers, packages, contacts, contracts, and balances.', noun: 'vendor', fields: [{ key: 'name', label: 'Company name', required: true }, { key: 'category', label: 'Category', required: true, options: defaultVendorCategories }, { key: 'link', label: 'Portfolio / social link', type: 'url', placeholder: 'https://...' }, { key: 'contact', label: 'Contact person' }, { key: 'phone', label: 'Phone' }, { key: 'quote', label: 'Quote / package' }, eventField], statuses: ['Considering', 'Shortlisted', 'Selected', 'Declined'] },
